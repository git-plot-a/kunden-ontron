...
export async function GET(req: Request) {
  ...
  const fields = url.searchParams.get("fields")
    ...
    : "summary,description,issuetype,created,customfield_10244,customfield_10010,customfield_10251,customfield_10227,customfield_10228,priority,updated,timetracking,status,resolutiondate";
